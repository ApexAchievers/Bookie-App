...
const AddBook = () => {
  return (
    <div className="bg-[url(./assets/images/bgimg.jpg)] bg-cover bg-no-repeat min-h-screen p-8">
  <div className="text-center mb-8">
    <h1 className="font-bold text-4xl text-violet-700">Manage Book Libraries</h1>
  </div>

  <form className="flex flex-wrap justify-center items-center gap-6 bg-white/70 p-6 rounded-xl shadow-lg max-w-5xl mx-auto h-[50vh]">
